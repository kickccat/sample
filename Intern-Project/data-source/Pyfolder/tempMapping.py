...
pathFile = r'C:\Users\yzhou\Documents\Workspace\Daten\mapping.xlsx'
destFile = r'C:\Users\yzhou\Documents\Workspace\Daten\mapping1.xlsx'
...
try:
    dataFrameOE = pd.read_excel(pathFile, na_values=naValues, encoding='latin1', warn_bad_lines=True)
...
#### Read the files from a folder path
#===============================================================================
